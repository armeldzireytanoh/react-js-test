        ...
        const sideList = (
            <div className={classes.list}>
                <List>
                    ...
                    <NavLink className={"unactivePage"}  activeClassName="activePage" exact to="/user" style={style_unset}>
                        <ListItem button key={'ListUserPage'}>
                            <ListItemIcon><SearchIcon /></ListItemIcon>
                            <ListItemText primary={'ListUserPage'} />
                        </ListItem>
                    </NavLink>

                    <NavLink className={"unactivePage"}  activeClassName="activePage" exact to="/add-user" style={style_unset}>
                        <ListItem button key={'AddUserPage'}>
                            <ListItemIcon><SearchIcon /></ListItemIcon>
                            <ListItemText primary={'AddUserPage'} />
                        </ListItem>
                    </NavLink>

                    <NavLink className={"unactivePage"}  activeClassName="activePage" exact to="/:id/edit-user" style={style_unset}>
                        <ListItem button key={'EditUserPage'}>
                            <ListItemIcon><SearchIcon /></ListItemIcon>
                            <ListItemText primary={'EditUserPage'} />
                        </ListItem>
                    </NavLink>
